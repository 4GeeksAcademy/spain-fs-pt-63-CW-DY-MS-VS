    ...
    <nav className="navbar navbar-dark navbar-expand-lg  bg-body-tertiary">
      <div className="container-fluid">
        ...
        <div className="d-flex float-end">
          ...
          {
            token && userData.client ? (<Link to="/shopping"><span className="px-2"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-cart4" viewBox="0 0 16 16">
